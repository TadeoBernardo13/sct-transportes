...
function EPFederalCETMRP() {
  ...
  const [inputs, setInputs] = useState({
    ...
    nombrePermisionario: "",
    nombreATA:
      "EXPEDICION DE PERMISO PARA EL SERVICIO DE A.F. DE CARGA ESPECIALIZADA MAT. PELIGROSO",
    ...
    <>
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <hr />
          <button
            onClick={() => navigate(`/expedidiondepermisosfederaldecargaespecializadaenmatpeligrosos_p`)}
...
export default EPFederalCETMRP