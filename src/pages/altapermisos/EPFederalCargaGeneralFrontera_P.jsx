...
function EPFederalCargaGeneralFrontera_P() {
  ...
  const [inputs_P, setInputs_P] = useState({
    ...
    nombreATA_P:
      "EXPEDICION DE PERMISO PARA EL SERVICIO DE A.F. DE CARGA GENERAL FRANJA FRONTERIZA",
    justificacion_P: "",
    estado: "PENDIENTE",
  });
  const {
      ...
      <div className="d-flex">
        ...
        <div className="content p-4">
          <h1 className="fs-3">
            ...
            CARGA GENERAL EN LOS CRUCES FRONTERIZOS
          </h1>
          ...
          <button
            onClick={() =>
              navigate("/expedidiondepermisosfederaldecargageneralfranjafronteriza")
            }
...
export default EPFederalCargaGeneralFrontera_P;
