...
function EPFederalCargaGeneralFrontera() {
    ...
    <>
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <button
            onClick={() =>
              navigate(`/expedidiondepermisosfederaldecargageneralfranjafronteriza_p`)
            }
...
export default EPFederalCargaGeneralFrontera;
