...
function EPSFederalPasaje() {
  return (
    <div className="d-flex">
      <Dashboard />
      <div className="content p-4">
        <h1 className="fs-3">
          EXPEDICION DE PERMISO PARA PRESTACION DEL SERVICIO DE AUTOTRANSPORTE
          FEDERAL DE PASAJE
        </h1>
        <form>
            ...
            <table className="table">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">4</th>
                  <td>
                    Comprobante de domicilio fiscal. Contrato de arrendamiento(
                    en su caso), Recibo de teléfono, agua, luz, tv por cable o
                    satelital, afore, IMSS, infonavit ( No mayor a 3 meses)
                  </td>
                  <td>
                    <div className="form-check">
                      <input
                ...
                <tr>
                  ...
                  <td>
                    ...
                    legal importación o documento que acrediten su legal
                    estancia en el país.
                  </td>
                  <td>
                    <div className="form-check">
                ...
                <tr>
                  <th scope="row">16</th>
                  <td>
                    Facturas ( CFD o CFDi) del pago de la Póliza del seguro
                    anual de responsabilidad civil por daños a terceros y del
                    seguro anual de viajero
                  </td>
                  <td>
                    <div className="form-check">
                      <input
                ...
                <tr>
                  <th scope="row">19</th>
                  <td>
                    Documento que acredite contar con Terminales de origen y
                ...
                <tr>
                  <th scope="row">20</th>
                  <td>
                    Documento que contenga la descripcion de la ruta solicitada
                  </td>
                  <td>
                    <div className="form-check">
                      <input
                ...
                <tr>
                  <th scope="row">21</th>
                  <td>
                    Documento que acredite contar con los horarios de servicio
                  </td>
                  <td>
                    <div className="form-check">
                      <input
                ...
                <tr>
                  <th scope="row">22</th>
                  <td>
                    En transportacion terrestre de o" hacia PUERTOS MARITIMOS o
                    AEROPUERTOS presentar convenio o autorizacion de quien tenga
                    a cargo la administración del lugar
                  </td>
                  <td>
                    <div className="form-check">
                      <input
...
export default EPSFederalPasaje;
