...
function EPFederalPasaje() {
  ...
  const [inputs, setInputs] = useState({
    ...
    fechaRecepcion: Date(),
    nombrePermisionario: "",
    nombreATA: "EXPEDICION DE PERMISO PARA EL SERVICIO DE A.F. DE PASAJE",
      ...
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <button
            onClick={() =>
              navigate(
                `/expedidiondepermisosfederaldepasaje_p`
              )
            }
...
export default EPFederalPasaje;
