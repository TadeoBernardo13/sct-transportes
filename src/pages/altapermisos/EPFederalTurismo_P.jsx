...
function EPFederalTurismo_P() {
  ...
  const [inputs_P, setInputs_P] = useState({
    ...
    nombreATA_P: "EXPEDICION DE PERMISO PARA EL SERVICIO DE A.F. DE TURISMO",
    justificacion_P: "",
    estado: "PENDIENTE",
  });
  const {
    ...
    <>
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <button
            onClick={() => navigate("/expedidiondepermisosfederaldeturismo")}
...
export default EPFederalTurismo_P;
