...
function EPPrivadoCargaGeneral_P() {
  ...
  const [inputs_P, setInputs_P] = useState({
    ...
    nombreATA_P:
      "EXPEDICION DE PERMISO PARA EL SERVICIO DE TRANSPORTE PRIVADO DE CARGA GENERAL",
    justificacion_P: "",
    estado: "PENDIENTE",
  });
  const {
    ...
    <>
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <button
            onClick={() =>
              navigate("/expedidiondepermisosprivadosdecargageneral")
            }
...
export default EPPrivadoCargaGeneral_P;
