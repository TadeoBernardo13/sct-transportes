...
function EPFederalCETMRPCF_P() {
  ...
  const [inputs_P, setInputs_P] = useState({
    ...
    nombreATA_P:
      "EXPEDICION DE PERMISO PARA EL SERVICIO DE A.F. DE CARGA ESPECIALIZADA EN FRANJA FRONTERIZA",
    justificacion_P: "",
    estado: "PENDIENTE",
  });
  const {
    ...
    <>
      <div className="d-flex">
        ...
        <div className="content p-4">
          <h1 className="fs-3">
            EXPEDICION DE PERMISO PARA PRESTAR EL SERVICIO DE AUTOTRANSPORTE
            FEDERAL DE CARGA ESPECIALIZADA PARA TRANSPORTE DE MATERIALES Y
            RESIDUOS PELIGROSOS EN LOS CRUCES PRONTERIZOS
          </h1>
          ...
          <button
            onClick={() => navigate("/expedidiondepermisosfederaldecargaespecializadaenfranjafronteriza")}
...
export default EPFederalCETMRPCF_P;
