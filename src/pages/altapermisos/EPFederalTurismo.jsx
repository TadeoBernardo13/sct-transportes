...
function EPFederalTurismo() {
  ...
  const [inputs, setInputs] = useState({
    ...
    fechaRecepcion: Date(),
    nombrePermisionario: "",
    nombreATA: "EXPEDICION DE PERMISO PARA EL SERVICIO DE A.F. DE TURISMO",
      ...
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <button
            onClick={() =>
              navigate(
                `/expedidiondepermisosfederaldeturismo_p`
              )
            }
...
export default EPFederalTurismo