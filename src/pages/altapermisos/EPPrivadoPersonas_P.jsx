...
function EPPrivadoPersonas_P() {
  ...
  const [inputs_P, setInputs_P] = useState({
    ...
    nombreATA_P:
      "EXPEDICION DE PERMISO PARA EL SERVICIO DE TRANSPORTE PRIVADO DE PERSONAS",
    justificacion_P: "",
    estado: "PENDIENTE",
  });
  const {
      ...
      <div className="d-flex">
        ...
        <div className="content p-4">
          ...
          <button
            onClick={() =>
              navigate(
                "/expedidiondepermisosprivadosdepersonas"
              )
            }
...
export default EPPrivadoPersonas_P;
